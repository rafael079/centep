...
class Administrador_Form_Aluno extends Zend_Form {
    ...
    public function init() {
        ...
        $classes = new Zend_Form_Element_Select('classes');
        $classes->setRequired(true)
               ...
               ->addFilter('StripTags')
               ->addFilter('StringTrim');
        $classes->setRegisterInArrayValidator(false);
        
        $situation = new Zend_Form_Element_Select('situation');
        $situation->setRequired(false)
               ->addMultiOptions(array('','0' => 'Em Andamento','1' => 'Aprovado', '2' => 'Reprovado'))
               ->setAttrib("data-error-type", "inline")
                ->setAttrib("class", "required")
               ->addFilter('StripTags')
               ->addFilter('StringTrim');
        ...
        $conclusion = new Zend_Form_Element_Hidden('conclusion');
        $conclusion->setRequired(false);
        ...
        $submit->setLabel("Proximo Passo - Selecionar Disciplinas");
