...
(function($, mango, undefined){
	...
	mango.loaded(function(){
		...
		$navi
			...
			.find('../static/img/adm').remove().end()
			.insertAfter('header');
	...
	mango.loaded(function(){
		if (window.devicePixelRatio && window.devicePixelRatio > 1) {
			var $img = $('.phone-title');
			if (!$img.is('../static/img/adm')) {
				$img = $img.find('../static/img/adm');
			}
	...
	mango.loaded(function(){
		...
		$('input:checkbox').checkbox({
			cls : 'checkbox',
			empty : '../../static/img/adm/elements/checkbox/empty.png'
		});
	...
	mango.ready(function(){
		...
		disableDrag.push($('header').find('../static/img/adm'));
		disableDrag.push($('div.avatar').find('../static/img/adm'));
	...
	/* mango.ready(function(){
		...
		mango.utils.preload([
			'../static/img/adm/layout/navigation/arrow-active.png',
			'../static/img/adm/layout/navigation/arrow-hover.png',
			'../static/img/adm/layout/navigation/arrow.png',
			'../static/img/adm/layout/navigation/bg-current.png',
			'../static/img/adm/layout/navigation/bg-active.png',
			'../static/img/adm/layout/navigation/bg-hover.png',
			'../static/img/adm/layout/navigation/bg-normal.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/layout/sidebar/bg-right.png',
			'../static/img/adm/layout/sidebar/bg.png',
			'../static/img/adm/layout/sidebar/divider.png',
			'../static/img/adm/layout/sidebar/shadow-right.png',
			'../static/img/adm/layout/sidebar/shadow.png',
			'../static/img/adm/layout/sidebar-right/header-bg.png',
			'../static/img/adm/layout/sidebar-right/nav-bg-hover.png',
			'../static/img/adm/layout/sidebar-right/nav-bg.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/layout/toolbar/bg.png',
			'../static/img/adm/layout/toolbar/buttons/bg-active.png',
			'../static/img/adm/layout/toolbar/buttons/bg-disabled.png',
			'../static/img/adm/layout/toolbar/buttons/bg-hover.png',
			'../static/img/adm/layout/toolbar/buttons/bg-red-active.png',
			'../static/img/adm/layout/toolbar/buttons/bg-red-disabled.png',
			'../static/img/adm/layout/toolbar/buttons/bg-red-hover.png',
			'../static/img/adm/layout/toolbar/buttons/bg-red.png',
			'../static/img/adm/layout/toolbar/buttons/bg.png',
			'../static/img/adm/layout/toolbar/buttons/divider.png'
		]);
		
		mango.utils.preload(['../static/img/adm/layout/footer/divider.png']);
		
				
		mango.utils.preload([
			'../static/img/adm/layout/bg.png',
			'../static/img/adm/layout/content/box/actions-bg.png',
			'../static/img/adm/layout/content/box/bg.png',
			'../static/img/adm/layout/content/box/header-bg.png',
			'../static/img/adm/layout/content/box/menu-active-bg.png',
			'../static/img/adm/layout/content/box/menu-arrow.png',
			'../static/img/adm/layout/content/box/menu-bg.png',
			'../static/img/adm/layout/content/box/menu-item-bg-hover.png',
			'../static/img/adm/layout/content/box/menu-item-bg.png',
			'../static/img/adm/layout/content/box/tab-hover.png',
			'../static/img/adm/layout/content/toolbar/bg-shortcuts.png',
			'../static/img/adm/layout/content/toolbar/bg.png',
			'../static/img/adm/layout/content/toolbar/divider.png',
			'../static/img/adm/layout/content/toolbar/popup-arrow.png',
			'../static/img/adm/layout/content/toolbar/popup-header.png',
			'../static/img/adm/layout/content/toolbar/user/arrow-normal.png',
			'../static/img/adm/layout/content/toolbar/user/avatar-bg.png',
			'../static/img/adm/layout/content/toolbar/user/avatar.png',
			'../static/img/adm/layout/content/toolbar/user/bg-hover.png',
			'../static/img/adm/layout/content/toolbar/user/bg-menu-hover.png',
			'../static/img/adm/layout/content/toolbar/user/counter.png'
		]);
		
		
		mango.utils.preload([
			'../static/img/adm/elements/alert-boxes/bg-error.png',
			'../static/img/adm/elements/alert-boxes/bg-information.png',
			'../static/img/adm/elements/alert-boxes/bg-note.png',
			'../static/img/adm/elements/alert-boxes/bg-success.png',
			'../static/img/adm/elements/alert-boxes/bg-warning.png',
			'../static/img/adm/elements/alert-boxes/error.png',
			'../static/img/adm/elements/alert-boxes/information.png',
			'../static/img/adm/elements/alert-boxes/note.png',
			'../static/img/adm/elements/alert-boxes/success.png',
			'../static/img/adm/elements/alert-boxes/warning.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/breadcrumb/bg-active.png',
			'../static/img/adm/elements/breadcrumb/bg-hover.png',
			'../static/img/adm/elements/breadcrumb/divider-active.png',
			'../static/img/adm/elements/breadcrumb/divider-hover.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/headerbuttons/bg-active.png',
			'../static/img/adm/elements/headerbuttons/bg-hover.png'
		]);
	
		mango.utils.preload([
			'../static/img/adm/elements/autocomplete/el-bg-hover.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/calendar/arrow-hover-bg.png'
		]);
		
		mango.utils.preload(['../static/img/adm/elements/charts/hover-bg.png']);
		
		mango.utils.preload([
			'../static/img/adm/elements/messages/button-active-bg.png',
			'../static/img/adm/elements/messages/button-hover-bg.png'
		]);
		...
		mango.utils.preload([
			'../static/img/adm/elements/mail/actions-bg.png',
			'../static/img/adm/elements/mail/button-bg-disabled.png',
			'../static/img/adm/elements/mail/button-bg-hover.png',
			'../static/img/adm/elements/mail/button-bg.png',
			'../static/img/adm/elements/mail/button-red-bg-hover.png',
			'../static/img/adm/elements/mail/button-red-bg.png',
			'../static/img/adm/elements/mail/button-red-disabled.png',
			'../static/img/adm/elements/mail/hover-bg.png',
			'../static/img/adm/elements/mail/mail.png',
			'../static/img/adm/elements/mail/text-arrow.png',
			'../static/img/adm/elements/mail/text-bg.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/fullstats/list/hover-bg.png',
			'../static/img/adm/elements/fullstats/simple/a-active.png',
			'../static/img/adm/elements/fullstats/simple/a-hover.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/checkbox/checked-active.png',
			'../static/img/adm/elements/checkbox/checked-disabled.png',
			'../static/img/adm/elements/checkbox/checked-hover.png',
			'../static/img/adm/elements/checkbox/checked-normal.png',
			'../static/img/adm/elements/checkbox/unchecked-active.png',
			'../static/img/adm/elements/checkbox/unchecked-disabled.png',
			'../static/img/adm/elements/checkbox/unchecked-hover.png',
			'../static/img/adm/elements/checkbox/unchecked-normal.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/radiobutton/checked-active.png',
			'../static/img/adm/elements/radiobutton/checked-disabled.png',
			'../static/img/adm/elements/radiobutton/checked-hover.png',
			'../static/img/adm/elements/radiobutton/checked-normal.png',
			'../static/img/adm/elements/radiobutton/unchecked-active.png',
			'../static/img/adm/elements/radiobutton/unchecked-disabled.png',
			'../static/img/adm/elements/radiobutton/unchecked-hover.png',
			'../static/img/adm/elements/radiobutton/unchecked-normal.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/colorpicker/arrow.png',
			'../static/img/adm/elements/colorpicker/bg.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/forms/icon-error.png',
			'../static/img/adm/elements/forms/icon-success.png',
			'../static/img/adm/elements/forms/tooltip-error-arrow.png',
			'../static/img/adm/elements/forms/tooltip-error.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/profile/change-active-bg.png',
			'../static/img/adm/elements/profile/change-hover-bg.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/search/arrow.png',
			'../static/img/adm/elements/search/glass.png',
			'../static/img/adm/elements/search/list-hover.png',
			'../static/img/adm/elements/search/loading.gif'
		]);

		mango.utils.preload([
			'../static/img/adm/elements/select/bg-active.png',
			'../static/img/adm/elements/select/bg-hover.png',
			'../static/img/adm/elements/select/bg-right-hover.png',
			'../static/img/adm/elements/select/list-hover-bg.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/settings/header-bg.png',
			'../static/img/adm/elements/settings/header-current-bg.png',
			'../static/img/adm/elements/settings/header-hover-bg.png',
			'../static/img/adm/elements/settings/seperator-current-left.png',
			'../static/img/adm/elements/settings/seperator-current-right.png',
			'../static/img/adm/elements/settings/seperator.png'
		]);

		mango.utils.preload([
			'../static/img/adm/elements/slide-unlock/lock-slider.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/spinner/arrow-down-active.png',
			'../static/img/adm/elements/spinner/arrow-down-hover.png',
			'../static/img/adm/elements/spinner/arrow-up-active.png',
			'../static/img/adm/elements/spinner/arrow-up-hover.png',
			'../static/img/adm/elements/table/pagination/active.png',
			'../static/img/adm/elements/table/pagination/disabled.png',
			'../static/img/adm/elements/table/pagination/hover.png',
			'../static/img/adm/elements/table/toolbar/hover.png',
			'../static/img/adm/elements/table/sorting-asc.png',
			'../static/img/adm/elements/table/sorting-desc.png',
			'../static/img/adm/elements/table/sorting.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/tags/bg.png',
			'../static/img/adm/elements/tags/left.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/to-top/active.png',
			'../static/img/adm/elements/to-top/hover.png',
			'../static/img/adm/elements/to-top/normal.png'
		]);
		
		mango.utils.preload(['../static/img/adm/elements/tooltips/bg.png']);
		
		mango.utils.preload([
			'../static/img/adm/elements/upload/bg-hover.png',
			'../static/img/adm/elements/upload/bg-normal.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/elements/wizard/arrow-current.png',
			'../static/img/adm/elements/wizard/arrow-error.png',
			'../static/img/adm/elements/wizard/arrow-normal.png',
			'../static/img/adm/elements/wizard/arrow-success.png',
			'../static/img/adm/elements/wizard/bg-current.png',
			'../static/img/adm/elements/wizard/bg-error.png',
			'../static/img/adm/elements/wizard/bg-normal.png',
			'../static/img/adm/elements/wizard/bg-success.png',
			'../static/img/adm/elements/wizard/bg.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/external/chosen-sprite.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/external/colorpicker/blank.gif',
			'../static/img/adm/external/colorpicker/colorpicker_background.png',
			'../static/img/adm/external/colorpicker/colorpicker_hex.png',
			'../static/img/adm/external/colorpicker/colorpicker_hsb_b.png',
			'../static/img/adm/external/colorpicker/colorpicker_hsb_h.png',
			'../static/img/adm/external/colorpicker/colorpicker_hsb_s.png',
			'../static/img/adm/external/colorpicker/colorpicker_indic.gif',
			'../static/img/adm/external/colorpicker/colorpicker_overlay.png',
			'../static/img/adm/external/colorpicker/colorpicker_rgb_b.png',
			'../static/img/adm/external/colorpicker/colorpicker_rgb_g.png',
			'../static/img/adm/external/colorpicker/colorpicker_rgb_r.png',
			'../static/img/adm/external/colorpicker/colorpicker_select.gif',
			'../static/img/adm/external/colorpicker/colorpicker_submit.png',
			'../static/img/adm/external/colorpicker/custom_background.png',
			'../static/img/adm/external/colorpicker/custom_hex.png',
			'../static/img/adm/external/colorpicker/custom_hsb_b.png',
			'../static/img/adm/external/colorpicker/custom_hsb_h.png',
			'../static/img/adm/external/colorpicker/custom_hsb_s.png',
			'../static/img/adm/external/colorpicker/custom_indic.gif',
			'../static/img/adm/external/colorpicker/custom_rgb_b.png',
			'../static/img/adm/external/colorpicker/custom_rgb_g.png',
			'../static/img/adm/external/colorpicker/custom_rgb_r.png',
			'../static/img/adm/external/colorpicker/custom_submit.png',
			'../static/img/adm/external/colorpicker/select.png',
			'../static/img/adm/external/colorpicker/select2.png',
			'../static/img/adm/external/colorpicker/slider.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/external/editor/buttons.gif',
			'../static/img/adm/external/editor/toolbar.gif'
		]);
		
		mango.utils.preload([
			'../static/img/adm/external/explorer/arrows-active.png',
			'../static/img/adm/external/explorer/arrows-normal.png',
			'../static/img/adm/external/explorer/crop.gif',
			'../static/img/adm/external/explorer/dialogs.png',
			'../static/img/adm/external/explorer/icons-big.png',
			'../static/img/adm/external/explorer/icons-small.png',
			'../static/img/adm/external/explorer/logo.png',
			'../static/img/adm/external/explorer/progress.gif',
			'../static/img/adm/external/explorer/quicklook-bg.png',
			'../static/img/adm/external/explorer/quicklook-icons.png',
			'../static/img/adm/external/explorer/resize.png',
			'../static/img/adm/external/explorer/spinner-mini.gif',
			'../static/img/adm/external/explorer/toolbar.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/external/gallery/blank.gif',
			'../static/img/adm/external/gallery/fancybox_buttons.png',
			'../static/img/adm/external/gallery/fancybox_loading.gif',
			'../static/img/adm/external/gallery/fancybox_sprite.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/external/jquery-ui/ui-bg_flat_0_000000_40x100.png',
			'../static/img/adm/external/jquery-ui/ui-bg_flat_30_000000_40x100.png',
			'../static/img/adm/external/jquery-ui/ui-bg_flat_65_e3e3e3_40x100.png',
			'../static/img/adm/external/jquery-ui/ui-bg_flat_75_ffffff_40x100.png',
			'../static/img/adm/external/jquery-ui/ui-bg_glass_55_fbf9ee_1x400.png',
			'../static/img/adm/external/jquery-ui/ui-bg_highlight-hard_100_f0f0f0_1x100.png',
			'../static/img/adm/external/jquery-ui/ui-bg_highlight-soft_100_e8e8e8_1x100.png',
			'../static/img/adm/external/jquery-ui/ui-bg_highlight-soft_75_b3bfcb_1x100.png',
			'../static/img/adm/external/jquery-ui/ui-bg_inset-soft_95_fef1ec_1x100.png',
			'../static/img/adm/external/jquery-ui/ui-icons_222222_256x240.png',
			'../static/img/adm/external/jquery-ui/ui-icons_2e83ff_256x240.png',
			'../static/img/adm/external/jquery-ui/ui-icons_3a4450_256x240.png',
			'../static/img/adm/external/jquery-ui/ui-icons_454545_256x240.png',
			'../static/img/adm/external/jquery-ui/ui-icons_888888_256x240.png',
			'../static/img/adm/external/jquery-ui/ui-icons_cd0a0a_256x240.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/external/uploader/backgrounds.gif',
			'../static/img/adm/external/uploader/buttons-disabled.png',
			'../static/img/adm/external/uploader/buttons.png',
			'../static/img/adm/external/uploader/delete.gif',
			'../static/img/adm/external/uploader/done.gif',
			'../static/img/adm/external/uploader/error.gif',
			'../static/img/adm/external/uploader/throbber.gif',
			'../static/img/adm/external/uploader/transp50.png'
		]);
		
		mango.utils.preload([
			'../static/img/adm/jquery-ui/accordion-header-active.png',
			'../static/img/adm/jquery-ui/accordion-header-hover.png',
			'../static/img/adm/jquery-ui/accordion-header.png',
			'../static/img/adm/jquery-ui/datepicker/arrow-left.png',
			'../static/img/adm/jquery-ui/datepicker/arrow-right.png',
			'../static/img/adm/jquery-ui/datepicker/button-bg.png',
			'../static/img/adm/jquery-ui/datepicker/button-hover-bg.png',
			'../static/img/adm/jquery-ui/datepicker/button-seperator.png',
			'../static/img/adm/jquery-ui/datepicker/day-current.png',
			'../static/img/adm/jquery-ui/datepicker/day-hover.png',
			'../static/img/adm/jquery-ui/datepicker/days-of-week-bg.png',
			'../static/img/adm/jquery-ui/datepicker/header-bg.png',
			'../static/img/adm/jquery-ui/datepicker/time-bg.png',
			'../static/img/adm/jquery-ui/datepicker/top-arrow.png',
			'../static/img/adm/jquery-ui/dialog-titlebar-close-hover.png',
			'../static/img/adm/jquery-ui/dialog-titlebar.png',
			'../static/img/adm/jquery-ui/loading.gif',
			'../static/img/adm/jquery-ui/progressbar/bg.png',
			'../static/img/adm/jquery-ui/progressbar/fill-blue-small.png',
			'../static/img/adm/jquery-ui/progressbar/fill-blue.gif',
			'../static/img/adm/jquery-ui/progressbar/fill-blue.png',
			'../static/img/adm/jquery-ui/progressbar/fill-grey.gif',
			'../static/img/adm/jquery-ui/progressbar/fill-grey.png',
			'../static/img/adm/jquery-ui/progressbar/fill-orange-small.png',
			'../static/img/adm/jquery-ui/progressbar/fill-orange.gif',
			'../static/img/adm/jquery-ui/progressbar/fill-orange.png',
			'../static/img/adm/jquery-ui/progressbar/fill-red-small.png',
			'../static/img/adm/jquery-ui/progressbar/fill-red.gif',
			'../static/img/adm/jquery-ui/progressbar/fill-red.png',
			'../static/img/adm/jquery-ui/slider/bg-range.png',
			'../static/img/adm/jquery-ui/slider/bg.png',
			'../static/img/adm/jquery-ui/slider/disabled-bg-range.png',
			'../static/img/adm/jquery-ui/slider/disabled-bg.png',
			'../static/img/adm/jquery-ui/slider/disabled-picker.png',
			'../static/img/adm/jquery-ui/slider/disabled-vertical-bg-range.png',
			'../static/img/adm/jquery-ui/slider/disabled-vertical-bg.png',
			'../static/img/adm/jquery-ui/slider/disabled-vertical-picker.png',
			'../static/img/adm/jquery-ui/slider/picker.png',
			'../static/img/adm/jquery-ui/slider/vertical-bg-range.png',
			'../static/img/adm/jquery-ui/slider/vertical-bg.png',
			'../static/img/adm/jquery-ui/slider/vertical-picker.png'
		]);
