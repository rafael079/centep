...
(!window.console || !console.log) && function() {
    for (var c = function() {
    }, a = "assert clear count debug dir dirxml error exception group groupCollapsed groupEnd info log markTimeline profile profileEnd markTimeline table time timeEnd timeStamp trace warn".split(" "), b = a.length, d = window.console = {}; b--; )
        d[a[b]] = c
}();
...
(function($, window, document) {
    ...
    $.fn[PLUGIN_NAME].defaults = {
        ...
        lang: {
            SHOW_ENTRIES: 'Mostrar Resultados:',
            SEARCH: 'Buscar:'
        }
    };
    ...
    $.fn[PLUGIN_NAME] = $.extend(function(method, options) {
        ...
        $(this).each(function() {
            ...
            if (inst = instances.filter(function(o) {
                ...
                instances.push({el: $el, inst: inst = self()});
            }
